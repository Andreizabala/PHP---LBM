...
<h1>LIBRARY</h1>
  ...
  <div class="search">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form" placeholder="Search" aria-label="Search" aria-describedby="basic-addon1" name="search" required autocomplete="off">
      <div class="input-group-prepend">
        <button type="submit" class="btn btn-danger" id="search-btn"><i class="fas fa-search"></i></button>
      </div>
    </div>
  </div>
  </div>
